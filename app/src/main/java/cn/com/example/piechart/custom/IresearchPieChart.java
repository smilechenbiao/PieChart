 ...
 */
public class IresearchPieChart extends PieRadarChartBase<PieData> {
    ...
    public IresearchPieChart(Context context) {
        super(context);
    }

    public IresearchPieChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IresearchPieChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new IresearchPieChartRenderer(this, mAnimator, mViewPortHandler);
        mXAxis = null;

        mHighlighter = new IresearchPieHighlighter(this);
    }
    ...
    public void setHoleColor(int color) {
        ((IresearchPieChartRenderer) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((IresearchPieChartRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((IresearchPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((IresearchPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((IresearchPieChartRenderer) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((IresearchPieChartRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((IresearchPieChartRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((IresearchPieChartRenderer) mRenderer).getPaintEntryLabels().setColor(color);
    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((IresearchPieChartRenderer) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((IresearchPieChartRenderer) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof PieChartRenderer) {
            ((IresearchPieChartRenderer) mRenderer).releaseBitmap();
        }
